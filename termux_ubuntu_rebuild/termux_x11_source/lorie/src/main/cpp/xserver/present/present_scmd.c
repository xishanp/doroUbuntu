...
/* lorie: called when the renderer notifies that a GPU copy batch finished, instead of waiting
 * for the next vblank poll. _safe iteration since present_re_execute() may destroy the vblank. */
void
